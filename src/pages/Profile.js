            ...
            <section className="content-profile">
              ...
              <div className="profile-sidebar">
                ...
                <div className="profile-menu">
                  <span
                    className="profile-menu-favorites onglets"
                    data-anim="1"
                  >
              ...
              <div className="profile-content">
                <div
                  className="profile-content-favorites contenu"
                  data-anim="1"
                >
                  <span>
                ...
                >
                  ...
                  <div className="cards">
                    <div
                      className="card-plan-one card spa-onglets"
                      data-spa="13"
                    >
                      <span className="price">FREE</span>
                    </div>
                    <div
                      className="card-plan-two card spa-onglets"
                      data-spa="13"
                    >
